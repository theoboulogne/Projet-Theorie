...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined TESTSTYPE_IS_TRIVIAL && TESTSTYPE_IS_TRIVIAL)))
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMM", "';'", "'+'",
  "'-'", "'*'", "'/'", "$accept", "ligne", "expr", YY_NULLPTR
};
...
#define yyclearin       (yychar = TESTEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use TESTerror or TESTUNDEF. */
#define YYERRCODE TESTUNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = TESTEMPTY; /* Cause a token to be read.  */
  goto yysetstate;
...
#line 27 "test.y"
                    { }
#line 1075 "test.tab.cpp"
    break;

  case 3: /* ligne: ligne expr ';'  */
#line 28 "test.y"
                   { printf("test = %d\n", (yyvsp[-1].val)); }
#line 1081 "test.tab.cpp"
    break;

  case 4: /* expr: NUMM  */
#line 31 "test.y"
                     { (yyval.val) = (yyvsp[0].val); }
#line 1087 "test.tab.cpp"
    break;

  case 5: /* expr: expr '+' expr  */
#line 32 "test.y"
                    { (yyval.val) = (yyvsp[-2].val) + (yyvsp[0].val); }
#line 1093 "test.tab.cpp"
    break;

  case 6: /* expr: expr '-' expr  */
#line 33 "test.y"
                    { (yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val); }
#line 1099 "test.tab.cpp"
    break;

  case 7: /* expr: expr '*' expr  */
#line 34 "test.y"
                    { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); }
#line 1105 "test.tab.cpp"
    break;

  case 8: /* expr: expr '/' expr  */
#line 35 "test.y"
                    { (yyval.val) = (yyvsp[-2].val) / (yyvsp[0].val); }
#line 1111 "test.tab.cpp"
    break;
...
yyerrlab:
  ...
  yytoken = yychar == TESTEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
